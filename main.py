...
class TradingBot:
    ...
    def buy_order(self):
        ...
        Usd_before_method_applied = account_details["balances"][2]["free"]
        Etherium_before_method_applied = account_details["balances"][3]["free"]
        Bnb_before_method_applied = account_details["balances"][0]["free"]
        order = self.client.create_order(symbol=SYMBOL, side="buy", quantity=QNTY, type="MARKET")
        account_details = client.get_account()
        Usd_after_method_applied = account_details["balances"][2]["free"]
        Etherium_after_method_applied = account_details["balances"][3]["free"]
        Bnb_before_after_applied = account_details["balances"][0]["free"]
